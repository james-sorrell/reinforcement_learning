...
class Agent():
    def __init__(self, eps=0.001, gamma=0.99):
        # Value function dict
    ...
    def init_policy(self):
        ...
        for state in self.state_space:
            # equal probability of choosing any action for all states
            policy[state] = [1/n for _ in range(n)]
        self.policy = policy

    def choose_action(self, state):
        # sampling policy distribution over actions for given state
